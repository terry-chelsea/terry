...
class MigrationTask : public Task
{
    ...
    private :
        ...
        void notice_dest_recovery();

        void after_set_recovery(void *req , RET_TYPE type , void *data);

        void retry_set_retry();

        void do_callback(bool ret);

        void after_log_operation(bool);
    ...
    private :
        ...
        int m_retry_time;
        bool m_dest_migrate_ret;    //记录对端操作的结果（第一步）
};
