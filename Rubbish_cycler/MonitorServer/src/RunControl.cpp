...
bool RunControl::can_register(RULE_TYPE type)
{
    ...
    if(MU_RULER == type)
    {
        std::cerr<<"..........check MU..."<<std::endl;
        return !m_mu_finish;
    }
    else
    {
        std::cerr<<"..........check SU..."<<std::endl;
        return !m_su_finish;
    }
}
...
void RunControl::node_register(struct Register_Info info , RULE_TYPE type)
{
    ...
    else
    {
        ...
        {
            std::cerr<<"All SU register now , finish register SU ..."<<std::endl;
            finish_register(type);
        }
    }
...
void RunControl::notice_all_node(RULE_TYPE type)
{
    ...
    if(MU_RULER == type)
    {
        ...
        for(it = m_mu_register_list.begin() ; it != m_mu_register_list.end() ; ++ it)
        {
            ...
            cerr<<"MU node IP : "<<(*it).ip<<std::endl;
        }
    }
    else if(SU_RULER == type)
    {
        ...
        {
            used_ip_vec.push_back((*it).ip);
            cerr<<"SU node IP : "<<(*it).ip<<std::endl;
        }
    }
    else 
    {
...
void RunControl::after_init_system(bool ret , RULE_TYPE type)
{
    ...
    if(MU_RULER == type)
    {
        ...
        std::cerr<<"ACK to MU node is "<<ack<<std::endl;
    }
    else
    {
        ...
        std::cerr<<"ACK to SU node is "<<ack<<std::endl;
    }
    ...
    std::cerr<<"ACK to register node is "<<ack<<std::endl;
