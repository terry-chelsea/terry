...
TCPSocket::generateSocket(void)
{
    ...
    if (sockFd < 0)
        LOG_ERROR("TCPSocket::TCPSocket::socket");
    return sockFd;
}
...
TCPSocket::closeSocket(void)
{
    ...
    if (close(sockFd) < 0)
    {
        LOG_ERROR("TCPSocket::closeSocket::close");
        return -1;
    }
    sockFd = -1;
    return 0;
...
TCPSocket::disableLinger(void)
{
    ...
    {
        LOG_ERROR("TCPSocket::disableLinger::setsockopt");
        return -1;
    }
    return 0;
}
...
TCPSocket::enableReuseaddr(void)
{
    ...
    {
        LOG_ERROR("TCPSocket::enableReuseaddr::setsockopt");
        return -1;
    }
    return 0;
}
...
TCPSocket::disableNagle(void)
{
    ...
    {
        LOG_ERROR("TCPSocket::disableNagle::setsockopt");
        return -1;
    }
    return 0;
}
...
TCPSocket::setNonblock(void)
{
    ...
    {
        LOG_ERROR("TCPSocket::setNonBlock::fcntl-F_GETFL");
        return val;
    }
    val |= O_NONBLOCK;
    if (fcntl(sockFd, F_SETFL, val) < 0)
    {
        LOG_ERROR("TCPSocket::setNonBlock:fcntl");
        return -1;
    }
    return 0;
}
...
TCPSocket::bindAddr(SocketAddress& servaddr)
{
    if( ipType == IPV4 )
    {
        ...
        else
        {
            ...
            {
                LOG_ERROR("TCPSocket::bindAddr::inet_addr: IP Address Invalid");
                return -1;
            }
        }
        ...
        if (servaddr.port == 0)
        {
            LOG_ERROR("TCPSocket::bindAddr: Port Invalid");
            return -1;
        }
        ...
        if (bind(sockFd, (const struct sockaddr*)&addr, sizeof(addr)) < 0)
        {
            ...
            LOG_ERROR("TCPSocket::bindAddr : bind error, Port is %d" , servaddr.port);
            return -1;
        }
    }
    else
    {
        ...
        if(  bind( sockFd, (const struct sockaddr*)&addr, sizeof(addr)) < 0)
        {
            LOG_ERROR("TCPSocket::bindAddr::bind");
            return -1;
        }
...
TCPSocket::listenOn(int qs)
{
    ...
    {
        LOG_ERROR("TCPSocket::listenOn::listen");
        return -1;
    }
    return 0;
}
...
TCPSocket::connectSocket(SocketAddress&  ipaddr)
{
    ...
    if( ipType == IPV4 )
    {
        ...
        if ( ipaddr.ifAnyAddr() )
        {
            LOG_ERROR("TCPSocket::connect:ipaddr.ip NULL");
            return -1;
        }
        else
        {
        ...
        if (ipaddr.port == 0)
        {
            LOG_ERROR("TCPSocket::connect:ipaddr.Port Invalid");
            return -1;
        }
    ...
    else
    {
        ...
        if( ipaddr.ifAnyAddr())
        {
            LOG_ERROR("TCPSocket::connect:ipaddr.ip AnyAddr");
            return -1;
        }
        else
        {
...
TCPSocket::setKeepAlive( void)
{
    ...
    {
        LOG_ERROR("TCPSocket::setKeepAlive::setsockopt");
        return -1;
    }
