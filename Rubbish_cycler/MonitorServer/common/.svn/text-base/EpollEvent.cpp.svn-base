...
int EpollEvent::closeRevent( void )
{
    ...
    {
        LOG_ERROR("EpollEvent::CancelRevent");
        return FAILED;
    }
    return SUCCESSFUL;
}
...
int EpollEvent::openRevent( void )
{
    ...
    {
        LOG_ERROR("EpollEvent::OpenlRevent");
        return FAILED;
    }
...
int EpollEvent::closeWevent( void )
{
    ...
    if(m_Epoll->doEvent(this, mFd,\
                        EVENTCHANGE, mEpollEvent.event ) < 0)
    {
        LOG_ERROR("EpollEvent::CancelWevent");
        return FAILED;
    }
...
int EpollEvent::openWevent( void)
{
    ...
    if(!(mEpollEvent.write))
    {
        ...
        if( m_Epoll->doEvent(this, mFd,\
                             EVENTCHANGE, mEpollEvent.event) < 0)
        {
            LOG_ERROR("EpollEvent::OpenWevent");
            return FAILED;
        }
    }
    return SUCCESSFUL;
...
int EpollEvent::registerREvent(void)
{
    ...
    {
        LOG_ERROR("EpollEvent::registerREvent");
        return FAILED;
    }
...
int EpollEvent::registerWEvent(void)
{
    ...
    if( m_Epoll->doEvent(this, mFd,\
                         EVENTADD, mEpollEvent.event) < 0)
    {
        LOG_ERROR("EpollEvent::registerWEvent");
        return FAILED;
    }
    return SUCCESSFUL;
}
...
int EpollEvent::registerRWEvents(void)
{
    ...
    if(m_Epoll->doEvent(this, mFd,\
                        EVENTADD, mEpollEvent.event) < 0)
    {
        LOG_ERROR("EpollEvent::registerRWEvent");
        return FAILED;
    }
...
int EpollEvent::unregisterRWEvents(void)
{
    ...
    {
        LOG_ERROR("EpollEvent::UnregisterRWEvent");
        return FAILED;
    }
