...
void testMemPool()
{
    ...
    {
        test1[i] = (struct TEST1 *)allocBlock(sizeof(struct TEST1));
    }
#ifdef DEBUG
    ...
    for(i = BEGIN1 ; i < END1 ; ++i)
    {
        test2[i] = (struct TEST2 *)allocBlock(sizeof(struct TEST2));
    }
#ifdef DEBUG
    printMemPool(terryMemHead);
    ...
    for(i = BEGIN1 ; i < END1 ; ++i)
    {
        test3[i] = (struct TEST3 *)allocBlock(sizeof(struct TEST3));
    }
#ifdef DEBUG
    printMemPool(terryMemHead);
    ...
    for(i = BEGIN1 ; i < END1 ; ++i)
    {
        test4[i] = (struct TEST4 *)allocBlock(sizeof(struct TEST4));
    }
#ifdef DEBUG
    printMemPool(terryMemHead);
    ...
    for(i = BEGIN1 ; i < END1 ; ++i)
    {
        test5[i] = (struct TEST5 *)allocBlock(sizeof(struct TEST5));
    }
#ifdef DEBUG
    printMemPool(terryMemHead);
#endif
...
void testMemPool_2()
{
    ...
    for(i = 0 ; i < TEST_SIZE ; ++i)
    {
        test1[0] = (struct TEST1 *)allocBlock(sizeof(struct TEST1));
        freeBlock(&test1[0]);
    }
    for(i = 0 ; i < TEST_SIZE ; ++i)
    {
        test2[0] = (struct TEST2 *)allocBlock(sizeof(struct TEST2));
        freeBlock(&test2[0]);
    }
    for(i = 0 ; i < TEST_SIZE ; ++i)
    {
        test3[0] = (struct TEST3 *)allocBlock(sizeof(struct TEST3));
        freeBlock(&test3[0]);
    }
    for(i = 0 ; i < TEST_SIZE ; ++i)
    {
        test4[0] = (struct TEST4 *)allocBlock(sizeof(struct TEST4));
        freeBlock(&test4[0]);
    }
    for(i = 0 ; i < TEST_SIZE ; ++i)
    {
        test5[0] = (struct TEST5 *)allocBlock(sizeof(struct TEST5));
        freeBlock(&test5[0]);
    }
    DESTORY_MEMORY_POOL;
    gettimeofday(&end , NULL);
