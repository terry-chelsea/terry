 ...
 * =====================================================================================
 *
 *       Filename:  simple_log.c
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  02/25/13 16:11:40
 *       Revision:  none
 *       Compiler:  gcc
 *
...
void start_debug(int type , const char *filename)
{
...
void print_info(MSG_TYPE type_nr , int line , const char *file , const char *format , ...)
{
    ...
    if((INFO_MSG == type_nr) || (WARNING_MSG == type_nr))
        return ;
#endif
